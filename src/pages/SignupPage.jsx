...
export default function Example() {
  ...
  return (
    <div className="isolate bg-white px-6 py-4 sm:py-4 lg:px-8">
      <div
      ...
      <div className="mx-auto max-w-2xl text-center">
        <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Welcome To Sign up</h2>
